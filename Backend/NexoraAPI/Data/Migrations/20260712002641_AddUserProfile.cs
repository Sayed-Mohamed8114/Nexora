        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeBand = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Region = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImdBand = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StudiedCredits = table.Column<int>(type: "int", nullable: true),
                    NumOfPrevAttempts = table.Column<int>(type: "int", nullable: true),
