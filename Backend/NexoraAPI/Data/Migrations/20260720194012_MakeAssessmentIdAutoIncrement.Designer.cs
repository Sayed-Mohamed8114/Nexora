...
namespace NexoraAPI.Data.Migrations
{
    ...
    [Migration("20260720194012_MakeAssessmentIdAutoIncrement")]
    partial class MakeAssessmentIdAutoIncrement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexoraAPI.Models.AssessmentQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NexoraAPI.Models.QuestionOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NexoraAPI.Models.Recommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NexoraAPI.Models.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NexoraAPI.Models.AssessmentQuestion", b =>
                {
                    b.HasOne("NexoraAPI.Models.Assessment", "Assessment")
                        .WithMany()
            ...
            modelBuilder.Entity("NexoraAPI.Models.Course", b =>
                {
                    b.HasOne("NexoraAPI.Models.User", "Tutor")
                        .WithMany()
            ...
            modelBuilder.Entity("NexoraAPI.Models.QuestionOption", b =>
                {
                    b.HasOne("NexoraAPI.Models.AssessmentQuestion", "Question")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("NexoraAPI.Models.UserProfile", b =>
                {
                    b.HasOne("NexoraAPI.Models.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("NexoraAPI.Models.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
